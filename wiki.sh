...
rsync --exclude .htaccess --delete --stats -qazPe ssh /Library/WebServer/Documents/wiki houshuan@reganmian.net:~/public_html
...
rsync --delete -aqzPe ssh /wiki/sitemap.xml.gz houshuan@reganmian.net:~/public_html/
